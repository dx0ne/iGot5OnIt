...
function drop(event) {
    ...
    console.log(`Dragged element ID: ${data}`); // Log the data
    ...
    console.log(`Drop target coordinates: ${dropTargetCoords}`);
    ...
    if (isFirstDrop) {
        ...
        if (isAdjacent(firstDropCoords, dropTargetCoords)) {
            ...
            console.log("Drop can only happen on adjacent elements (horizontally or vertically) to the first drop.");
        }
    }
}
